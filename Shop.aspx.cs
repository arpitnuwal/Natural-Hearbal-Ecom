...
public partial class Shop : System.Web.UI.Page
{
    ...
    private void LoadSliders()
    {
       ...
       else if (Request.QueryString["price"] == "7")
       {
        ...
        DataTable dtlstbestdeal = Cnn.FillTable("select ProductID,  SUBSTRING(ProductName, 1, 20) AS ProductName,ProductLink,Price,Discount ,(select top 1 imagepath from ProductImages where ProductID= Products.ProductID order by ProductID) as img1 from Products where 1=1 "+cid+" "+sid+" "+bid+"  "+price+"   "+sort+"", "Detail");
